...
from classification.data import download, generate_lego_part_classes
from classification.common import utils, tools
from classification.preprocess import build_features
import engine, model
...
part_class_path: Path = repo_root_dir / "classification" / "data" / "parts.csv"
