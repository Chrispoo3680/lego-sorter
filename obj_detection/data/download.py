...
from obj_detection.common import tools
import os
import logging
import wget
...
def kaggle_download_data(
    ...
    # kaggle.api.dataset_download_files(data_handle, path=save_path, unzip=False, quiet=False)
...
if __name__ == "__main__":
    ...
    kaggle_download_data(
        data_handle=config["b200_kaggle_dataset_handle"],
        save_path=save_path,
        data_name=config["b200_kaggle_dataset_name"],
